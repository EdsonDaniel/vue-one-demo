...
import TablePrmCap from "@/components/TablePrmCap.vue";
...
const getPromociones = async function (){
  let response = await getData(baseUrl + 'prom?compr=' + user.nomCto)
...
-->
    ...
    <SectionMain>
      ...
      title="Todas las Promociones Capturadas" main>
      </SectionTitleLine>
      <!---->
      <CardBox v-if="tieneCapturas" class="mb-6" has-table>
        <TablePrmCap :promos="promos" />
      </CardBox>
